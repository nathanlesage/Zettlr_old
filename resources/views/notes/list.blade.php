       ...
       {{-- The content of the notes will be dynamically loaded --}}
        ...
        <div class="panel panel-default">
  			<div class="panel-heading">
    			<h3 class="panel-title onClickLoadNote" id="{{ $note->id }}" style="cursor:pointer;">{{ $note->id }} &mdash; {{ $note->title }} <a href="#" class="pull-right onClickRemoveNote" id="{{ $note->id }}"><span class="glyphicon glyphicon-remove"></span></a></h3>
  			</div>
		</div>
        @endforeach
        </div>
