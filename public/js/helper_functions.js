		...
		function addReference(referenceId = 0)
		    {
		    	...
		    	$("#referenceList").append('<div class="alert alert-info alert-dismissable"><input type="hidden" value="'+referenceId+'" name="references[]">'+$("#referenceSearchBox").val()+' <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
