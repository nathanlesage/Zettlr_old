...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <div class="jumbotron" style="margin-top:25%;">
            <h1>Zettlr</h1>
            <form class="form-inline" role="login" method="POST" action="<?php echo e(url('/login')); ?>" id="loginForm">
                <?php echo csrf_field(); ?>


                <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                    <input type="email" class="form-control loginInputField" name="email" autofocus="autofocus" placeholder="Email" value="<?php echo e(old('email')); ?>">
                </div>
